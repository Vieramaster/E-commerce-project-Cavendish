...
export const SellCounter = ({
  ...
  return (
    <section className="w-full py-6 bg-mainColor flex justify-center lg:h-72 2xl:h-80">
      <div className="w-80 h-full flex flex-col gap-5 lg:flex-row lg:w-5/6 lg:justify-around">
        ...
        <div className="w-full h-1/2 flex flex-col justify-start items-center lg:w-auto lg:h-60 lg:justify-center lg:items-start 2xl:gap-5">
