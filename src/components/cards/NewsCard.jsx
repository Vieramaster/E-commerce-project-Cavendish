import { TopButtonCard } from "../buttons";
import { RightArrowIco } from "../SVGs/icons";

const NewsCard = ({ image, imageAlt, date, title, introduction}) => {
  return (
    <div
    ...
    >
      <div className="h-2/3 w-full relative">
        ...
        <TopButtonCard label={"go to"} background={"primary"}>
